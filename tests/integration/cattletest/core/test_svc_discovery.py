...
def test_link_volumes(client, context):
    ...
    secondary_lc = {"imageUuid": image_uuid, "name": "secondary", "labels": labels}
...
def test_healtcheck(client, context, super_client):
    ...
    health_c = super_client.list_healthcheckInstance(accountId=service.accountId, instanceId=c.id)
